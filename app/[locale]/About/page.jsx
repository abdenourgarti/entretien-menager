    ...
    return (
        <div>
            ...
            <div className="bg-gradient-to-b to-white from-blue-100 py-12 px-4 text-center mb-24">
                <h2 className="text-3xl font-bold text-gray-800 mb-4">Prêt à travailler avec nous ?</h2>
                <p className="text-lg text-gray-600 leading-relaxed mb-6">Prenez rendez-vous dès maintenant pour en discuter.</p>
